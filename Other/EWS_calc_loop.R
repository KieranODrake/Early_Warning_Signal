...
for ( z in 1 : length( filenames ) ){
  ...
  #' Save outputs
  if ( lead_ind_type == 2) {
    setwd('C:/Users/kdrake/OneDrive - Imperial College London/Documents/Transmission Fitness Polymorphism scanner (tfpscanner)/tfps runs/2022_10/analysis/p_val_filter_005/EWS_calc_outputs_co_lgr')
